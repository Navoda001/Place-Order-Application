...
public class CustomerDto {
    ...
    public String toString() {
        return "CustomerDto{" + "id=" + getId() + ", title=" + getTitle() + ", name=" + getName() + ", dob=" + getDob() + ", salary=" + getSalary() + ", address=" + getAddress() + ", city=" + getCity() + ", province=" + getProvince() + ", postalCode=" + getPostalCode() + '}';
    }
